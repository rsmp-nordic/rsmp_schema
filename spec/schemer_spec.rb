RSpec.describe RSMP::Schema do
  ...
  it 'provides schema versions' do
    ...
    expect(RSMP::Schema.versions(:tlc)).to eq(['1.0.7', '1.0.8', '1.0.9', '1.0.10', '1.0.13', '1.0.14', '1.0.15',
                                               '1.1.0', '1.2.0', '1.2.1'])
  ...
  it 'can load and remove custom schema' do
    expect(RSMP::Schema.schema_types).to eq(%i[core tlc])
    type = :custom
    path = File.expand_path(File.join(__dir__, '..', 'schemas', 'tlc'))
    RSMP::Schema.load_schema_type type, path
    expect(RSMP::Schema.schema_types).to eq(%i[core tlc custom])
    expect(RSMP::Schema.versions(type)).to eq(['1.0.7', '1.0.8', '1.0.9', '1.0.10', '1.0.13', '1.0.14', '1.0.15',
                                               '1.1.0', '1.2.0', '1.2.1'])
